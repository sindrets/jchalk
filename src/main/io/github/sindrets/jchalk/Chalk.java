...
public class Chalk {
    ...
    private static final Pattern ansiEscapeRegex = Pattern
            .compile("(?:\u001B[@-_]|[\u0080-\u009F])[0-?]*[ -/]*[@-~]");

    private ArrayList<Style> styles = new ArrayList<>();

    public static int visibleLength(String s) {
        return ansiEscapeRegex.matcher(s).replaceAll("").length();
    }
    ...
    public Chalk rgb(int r, int g, int b) {
        return this
                .clone(new Style(String.format("\u001b[38;2;%d;%d;%dm", r % 256, g % 256, b % 256),
                        AnsiStyle.BLACK.close));
    }

    public Chalk bgRgb(int r, int g, int b) {
        return this
                .clone(new Style(String.format("\u001b[48;2;%d;%d;%dm", r % 256, g % 256, b % 256),
                        AnsiStyle.BG_BLACK.close));
    }
